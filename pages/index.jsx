...
function Home({ posts }) {
  ...
  const updateValue = () => {
    ...
    let Total_Dataneuron_ALP_cost =
      Masterlist_cost + Annotation_cost + Prediction_cost + Annotator_SME_cost;
    ...
    let total_time_data_neuron_tool =
      (time_taken_for_thousand_paras_manual_validation / 1000) * total_paras;
    ...
    >
      <div className={"px-5 lg:px-14 pt-24 lg:pt-0"}>
        <div className="flex justify-center w-full lg:pt-0">
          <div className={"lg:w-4/5 text-center lg:text-4xl text-3xl w-full"}>
            Advanced platform for complex data annotations, model training,
        ...
        <Fade>
          ...
          <p className={"text-2xl md:text-4xl"}>
            DataNeuron helps you accelerate and automate human-in-loop labeling
            for developing AI solutions. Powered by a data-centric platform, we
            automate data labeling, the creation of models, and end-to-end
          ...
          <div className="xl:flex justify-between">
            <div>
              <div className={"text-2xl md:text-4xl"}>
                Our Aim is to accelerate the development of AI models and
            ...
            <div className={"flex justify-center"}>
              <img width={400} src="/img/animation.gif" alt="goals" />
            </div>
          </div>
        </Fade>
        ...
        <Fade>
          ...
          <div className={"my-3 lg:flex lg:space-x-2 lg:space-y-6"}>
            <div className="lg:w-1/2 h-56 overflow-y-auto w-full border-2 border-gray-300 p-3 mb-3 md:mb-0">
              <div className="text-blue-500 mb-2">If you use DataNeuron</div>
              <div>
                <div>
                  <div className={"text-sm md:text-md"}>Total Classes</div>
                  <div>
                ...
                <br />
                <div>
                  <div className={"text-sm md:text-md"}>Total Paragraphs</div>
                  <div>
                    <div className="flex items-center">
                      <div className={"flex-grow mr-2"}>
                        <input
            ...
            <div className="lg:w-1/2 relative lg:-top-6 md:h-56 w-full border-2 border-gray-300 p-6">
              <div className="md:flex h-full">
                ...
                <div className="md:w-1/2 md:px-2 h-full">
                  ...
                  <div className="py-3 px-3 w-full text-blue-600">
                    <p>ROI</p>
                    <p className={"text-xl font-bold"}>{output.roi}%</p>
                  </div>
                </div>
              </div>
            </div>
