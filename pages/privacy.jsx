        ...
        <div className="bg-white w-full">
            ...
            <Layout>
                <div className={"p-5 md:p-12"}>
                    ...
                    <p>
                    This Privacy Policy shall be read in conjunction with the Terms of Use available at www.dataneuron.ai. Your access to and use of the Website and Services is conditional upon your acceptance of this Privacy Policy and the Terms of Use. By accessing and/or using the Website and/or Services, you consent to your information and data being collected, stored and used in the manner laid out in this Privacy Policy.
                    </p>
                    <div className="my-8">
                        <h2 className="mb-5 font-bold text-lg">1. Collection of Information</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5 font-bold text-lg">2. Use of Information</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5 font-bold text-lg">3. Cookie Policy</h2>
                        <p className="mb-10">
                        ...
                        <ul className="mb-10">
                            ...
                            <li>Security</li>
                            <li>Insights Measurement</li>
                            <li>Improving features and services on the Website</li>
                        ...
                        <h2 className="mb-5 font-bold text-lg">4. Consent</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5 font-bold text-lg">6. Security</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5 font-bold text-lg">7. Grievance Officer</h2>
                        <p className="mb-10">
                        ...
                        <p>3260, Hillview Avenue, Palo Alto,</p>
                        <p>CA - 94304, USA</p>
                        <p className="my-5">
                            Email:<a>bharath@dataneuron.ai</a>
                        </p>
                        <h2 className="mb-5">8. Changes to the Privacy Policy</h2>
                        <p className="mb-10">
                            DataNeuron reserves the right to update or modify this Privacy Policy at any time. Any change to this Privacy Policy shall be deemed to be effective as soon as such change reflects on <a>www.dataneuron.ai</a>. As a user of the Website and/or Services, you are advised to check this Privacy Policy periodically to keep yourself updated on any changes. You hereby acknowledge that any collection, storage, processing or other use of Your Information shall be governed by the Privacy Policy as applicable at the time of such collection, storage, processing or other use.
                        </p>
                    </div>
                </div>
            </Layout>
