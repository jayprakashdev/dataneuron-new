        ...
        <div className="w-full" style={{background:"#ffffff", minHeight:'100vh'}}>
            <Layout>
                <div className="w-full">
                    <h1 className="flex justify-center w-full mb-5 text-3xl">Resource Centre</h1>
                    <p className="mb-14 w-full flex justify-center text-gray-500 text-xl">Find Resources for DataNeuron - Case Studies, Whitepapers and Feature Catalog</p>
                    <div className="w-full flex justify-center">
                        <div className="flex justify-between space-x-3" style={{width:'50%'}}>
                    ...
                    <div className="mt-14 w-full flex justify-between flex-wrap">
                        <div style={{width: 400 , margin : 10}}>
                            <div className="border-t-2 border-b-2 py-2" style={{borderTop:"2px solid #E0E0E0",borderBottom:"2px solid #E0E0E0"}}>
                                <p className="mb-4 text-xs">CASE STUDY</p>
                                <ImageCard/>
                            </div>
                        </div>
                        <div style={{width: 400 , margin : 10}}>
