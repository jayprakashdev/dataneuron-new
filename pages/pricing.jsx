    ...
    <div className="w-full" style={{ background: "#fafafa" }}>
      ...
      >
        ...
        <div
          ...
          style={{ fontSize: 20 }}
        >
          Use The Time Machine for AI to accelerate your model development!
        </div>
        <br />
        <br />
        <div
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center ">
              <Link href={"https://alpclientofficial.azurewebsites.net/"}>
                <a
            ...
            <div>
              <div className="flex">
                <img src="/img/per.svg" className={"px-3"} alt="per price" />
                <div>$0.1 Per Annotation for every correct validation</div>
              </div>
              <br />
              <div className="flex">
                <img
          ...
          >
            ...
            <div>
              <div>
                ...
                <br />
                <div className="flex">
                  <img className={"px-3"} src="/img/data.svg" alt="per price" />
                  <div>1 GB Data Asset Upload</div>
                </div>
                <br />
                <div className="flex">
                  <img
                  ...
                  />
                  <div>
                    Export Datasets, Masterlist and Model Block through API.
                  </div>
                </div>
                <br />
                <div className="flex">
                  <img
                    ...
                    alt="per price"
                  />
                  <div>Batch and Single Data Point API</div>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <br />
            <div className="text-gray-500">
              Best suited for large projects with NLP as a major service to
              users.
            </div>
            <br />
            <div className="flex justify-center">
            ...
            <div>
              ...
              <div className="ml-6">
                ...
                <div className="flex">
                  <img className={"px-3"} src="/img/api.svg" alt="api" />
                  <div>Batch API</div>
                </div>
                <div className="flex">
                  <img
        ...
        <div style={{ padding: 70 }}>
          ...
          <div className="flex flex-wrap justify-center space-x-3">
            ...
            >
              ...
              <div className={"my-1 flex md:block justify-center items-center"}>
                <div className="text-2xl text-gray-400 pr-2">01</div>
                <div className="font-bold">No Code Prediction</div>
              </div>
              <div className={"text-center md:text-left"}>
                Natural Language Prediction without writing a single line of
                code!
              </div>
            </div>
            <div
            ...
            >
              ...
              />
              <div className={"my-1 flex md:block justify-center items-center"}>
                <div className="text-2xl text-gray-400 pr-2">02</div>
                <div className="font-bold">Guided Annotation</div>
              </div>

              <div className={"text-center md:text-left"}>
                DataNeuron performs guided and automated annotation on the data.
              </div>
            </div>
            <div
              className="p-3 lg:border-r-2 lg:border-b-0 border-gray-300 flex md:block items-center flex-col"
            ...
            >
              ...
              />
              <div className={"my-1 flex md:block justify-center items-center"}>
                <div className="text-2xl text-gray-400 pr-2">03</div>
                <div className="font-bold">Secure Platform</div>
              </div>
              <div className={"text-center md:text-left"}>
                Secure Data Platform for data exchange and model creation.
              </div>
            </div>
            <div
              className="p-3 lg:border-r-2 lg:border-b-0 border-gray-300 flex md:block items-center flex-col"
            ...
            >
              ...
              />
              <div className={"my-1 flex md:block justify-center items-center"}>
                <div className="text-2xl text-gray-400 pr-2">04</div>
            ...
            >
              ...
              />
              <div className={"my-1 flex md:block justify-center items-center"}>
                <div className="text-2xl text-gray-400 pr-2">05</div>
