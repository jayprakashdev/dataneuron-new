...
const PrivacyPage=()=>{
    return (
        <div className="bg-white w-full">
            <Layout>
                <div className="w-full ml-5" style={{marginTop:'-50px'}}>
                    ...
                    <div className="my-8">
                        <h2 className="mb-5">1. Collection of Information</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5">2. Use of Information</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5">3. Cookie Policy</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5">4. Consent</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5">5. Disclosure and Transfer of Information</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5">6. Security</h2>
                        <p className="mb-10">
                        ...
                        <h2 className="mb-5">7. Grievance Officer</h2>
                        <p className="mb-10">
