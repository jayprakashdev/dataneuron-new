      ...
      <div className="flex flex-wrap space-y-6 lg:space-y-0 py-5 px-5 lg:px-20">
        <div className=" xl:w-1/2 w-full">
          ...
          {showMsg && (
            ...
            >
              <div>
                Thank you for contacting us. <br /> We will get back to you as
                soon as possible.
              </div>
        ...
        <div className="xl:w-1/2 xl:pt-10 w-full flex flex-col items-center ">
          ...
          <div className={"w-full xl:w-4/5"}>
            ...
            <div className="flex flex-col md:flex-row justify-center md:justify-start items-center">
              ...
              <div className={"text-xl ml-6 text-center md:text-left"}>
                HQ - Stanford Research Park, 3260, Hillview Ave, &nbsp;Palo
                Alto, CA - 94304
              </div>
            </div>
            <br />
            <div className="flex flex-col md:flex-row xl:justify-center items-center">
              ...
              <div className={"text-xl text-center md:text-left ml-6"}>
                501, Incubation Centre - IIIT-D, Okhla Industrial Estate, Phase
